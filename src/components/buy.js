...
export default function Buy() {
    ...
    return (
        <>
            <div className="flex-1 bg-white shadow-lg border p-4 rounded h-full">

                <h3 className="font-bold text-xl">Buying From Bitpack</h3>
                ...
                <div className="my-2">
                    <button className="py-3 px-10 font-bold text-white rounded bg-green-500">Procced to Buy</button>
                </div>
            </div>
        </>
    )
